...
class CreateRequsitionSuppliesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('requsition_supplies', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('requsition_supplies');
    }
}
