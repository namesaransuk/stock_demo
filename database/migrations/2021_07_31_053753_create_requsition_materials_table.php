...
class CreateRequsitionMaterialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('requsition_materials', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('requsition_materials');
    }
}
