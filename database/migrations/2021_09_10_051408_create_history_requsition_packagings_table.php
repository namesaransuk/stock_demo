...
class CreateHistoryRequsitionPackagingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_requsition_packagings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('history_requsition_packagings');
    }
}
