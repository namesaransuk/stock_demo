...
class CreateRequsitionProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('requsition_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('requsition_products');
    }
}
