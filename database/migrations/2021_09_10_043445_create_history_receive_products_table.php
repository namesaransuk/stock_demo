...
class CreateHistoryReceiveProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_receive_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('history_receive_products');
    }
}
