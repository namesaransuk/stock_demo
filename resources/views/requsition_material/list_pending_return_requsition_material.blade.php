    ...
    <div class="row mb-2">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">ตรวจสอบและยืนยันการคืนวัตถุดิบ</li>
            </ol>
        </div><!-- /.col -->
        {{-- <div >
            <br>
                ...
                <table id="requsition_material_table" class="table w-100 " style="margin-top: 0!important; margin-bottom: 0!important;">
                    ...
                    <thead class="ogn-stock-yellow" >
                        <tr>
                            ...
                            <th scope="col" class="w-auto">วันที่คืน</th>
    ...
    $(function() {
        ...
        let requsition_material_table =$('#requsition_material_table').DataTable({
            "pageLength": 10,
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'{{route(('api.v1.requsition.material.pending.return.list'))}}',
                    'data':{
        ...
        function format ( receive ) {
            ...
            receiveMaterials.forEach(receive_item => {
                ...
                if (action == 1) {
                    ...
                    action = "<td style='text-align:center;'> <span class='badge badge-pill ogn-stock-green' style='text-align : center;'>อนุมัติการคืน</span> </td>"
                }
            ...
            var inner_table = `<table class="w-100">
                ...
                table =  '<table cellpadding="5" class="w-100" cellspacing="0" border="0" style="padding-left:50px;"><caption class="text-center text-dark text-bold pt-0">รายละเอียดคืนวัตถุดิบ</caption>'+inner_table+'</table>';
            ...
            $(document).on('click','.confirm-btn',function(){
                ...
                Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "post",
                                url: "{{route('api.v1.requsition.material.step.to.history')}}",
                                data: {'id':id},
                                dataType: "json",
