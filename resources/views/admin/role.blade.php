        ...
        <div class="col-12">
            <div class="card card-outline card-gdp">
                ...
                <div class="card-body p-0">
                    ...
                    <table id="role_table" class="table w-100" style="margin-top: 0!important; margin-bottom: 0!important;">
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #9BC56D;">
        <h5 class="modal-title" id="staticBackdropLabel" style="color: white;">เพิ่มรายการตำแหน่ง</h5>
...
@section('js')
    <script>
        ...
        $('#custom-search-input').keyup(function(){
            role_table.search($(this).val()).draw() ;
            })
        ...
        $(document).on('click','.btn-modal',function(){
            ...
            if(!id){
                ...
                $('.modal-title').text('เพิ่มรายการตำแหน่ง');
                $('#name').val('');
                $('#id').val('');

            } else {

                $('.modal-title').text('แก้ไขรายการตำแหน่ง');
                $.ajax({
                    type: "post",
                    url: "{{route(('api.v1.role.view.edit'))}}",
                    data: {'id':id},
                    dataType: "json",
        ...
        $('.btn-save').on('click', function() {
            ...
            if (!formData.id) {
                $.ajax({
                type: "post",
                url: "{{route(('api.v1.role.validate'))}}",
                data: formData,
                dataType: "json",
