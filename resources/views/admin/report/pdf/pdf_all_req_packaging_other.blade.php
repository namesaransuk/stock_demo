        ...
        <table class="border_table">
            <thead>
                <tr>
                    ...
                    <th class="border_table" style="width:750px;" rowspan="4"><h1>บันทึกการเบิก/คืนบรรจุภัณฑ์</h1>  </th>
        ...
        <table class="border_table">
            <tbody style="text-align: center">
                <tr>
                    ...
                    <td class="border_table" style="width:300px" colspan="4">การเบิกบรรจุภัณฑ์</td>
                    <td class="border_table" style="width:300px" colspan="4">การคืนบรรจุภัณฑ์</td>
                    <td class="border_table" style="width:50px" rowspan="2">เบิกจริง</td>
                    <td class="border_table" style="width:150px" colspan="3">หมายเหตุ</td>
                </tr>
                <tr>
                    ...
                    <td class="border_table" style="width:50px">คืนสต็อก</td>
                    <td class="border_table" style="width:50px">เคลม</td>
                    <td class="border_table" style="width:50px">ทำลาย</td>
                </tr>
                ...
                @endphp
                <tr>
                @foreach ($data[0]->packagingCutReturns as $data_one)
                    @php
                        $req_date = date_format(date_create($data_one->datetime),"d/m/Y");
                        $ret_date = date_format(date_create($data_one->date_re),"d/m/Y");

                    @endphp
                        <td class="border_table">{{$count}}</td>
                        <td class="border_table">{{$data_one->packagingLot->packaging->name}}</td>
                        <td class="border_table">{{$data_one->packagingLot->lot_no_pm}}</td>

                        <td class="border_table">{{$req_date}}</td>
                        <td class="border_table">{{$data_one->qty}}</td>
                        <td class="border_table">{{$data[0]->productionUser->employee->fname}}</td>
                        <td class="border_table">{{$data[0]->procurementUser->employee->fname}}</td>

                        <td class="border_table">{{$ret_date}}</td>
                        <td class="border_table">{{$data_one->qty_r}}</td>
                        <td class="border_table">{{$data[0]->productionUser->employee->fname}}</td>
                        <td class="border_table">{{$data[0]->stockUser->employee->fname}}</td>

                        <td class="border_table">{{$data_one->qty - $data_one->qty_r}}</td>

                        <td class="border_table">{{$data_one->met_good_re}}</td>
                        <td class="border_table">{{$data_one->met_claim_re}}</td>
                        <td class="border_table">{{$data_one->met_destroy_re}}</td>
