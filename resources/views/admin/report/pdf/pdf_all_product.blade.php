        ...
        <table class="border_table">
            <thead>
                <tr>
                    ...
                    <th class="border_table" style="width:900px"><h1>บันทึกการรับสินค้า</h1>  </th>
                </tr>
            </thead>
        </table>
        ...
        <table class="border_table">
            <tbody style="text-align: center">
                <tr>
                    ...
                    <td class="border_table" style="width:100px" rowspan="1">จำนวนที่รับเข้า</td>
                    <td class="border_table" style="width:100px" rowspan="1">ผลการตรวจสอบ (ผ่าน/ไม่ผ่าน)</td>
                    <td class="border_table" style="width:100px" rowspan="1">การจัดการ (กรณีไม่ผ่าน)</td>
                    <td class="border_table" style="width:100px" rowspan="1">Lot</td>
                    <td class="border_table" style="width:200px" rowspan="1">หมายเหตุ</td>
                ...
                @foreach ($data as $data_one)
                    <tr>
                        ...
                        <td class="border_table">{{$data_one->product->name}}</td>
                        ...
                        <td class="border_table">{{$data_one->receiveproduct->recap === null?'ไม่มีข้อมูล':$data_one->receiveproduct->recap}}</td>
                        <td class="border_table">{{$data_one->receiveproduct->stockUser->employee->fname}}</td>

                        @if ($data_one->receiveproduct->productionUser)
                            <td class="border_table">{{$data_one->receiveproduct->productionUser->employee->fname}}</td>
                        @else
                            <td class="border_table"> - </td>
                        @endif
                    </tr>
