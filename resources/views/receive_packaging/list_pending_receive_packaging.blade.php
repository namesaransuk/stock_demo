    ...
    <div class="row mb-2">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">รอการดำเนินการรับเข้าบรรจุภัณฑ์</li>
            </ol>
        </div><!-- /.col -->
        <div >
            <br>
    ...
    $(function() {
        ...
        let receive_packaging_table =$('#receive_packaging_table').DataTable({
            "pageLength": 10,
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'{{route(('api.v1.receive.packaging.pending.list'))}}',
                    'data':{
            ...
            $(document).on('click','.confirm-btn',function(){
                ...
                Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "post",
                                url: "{{route('api.v1.receive.packaging.step.history')}}",
                                data: {'id':id},
                                dataType: "json",
