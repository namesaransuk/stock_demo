        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item active">ประวัติการนำเข้าบรรจุภัณฑ์</li>
                </ol>
            </div><!-- /.col -->
            <div>
                <br>
        ...
        <div class="col-12">
            <div class="card card-outline card-gdp">
                <div class="card-body p-0">
                    ...
                    <table id="receive_packaging_table" class="table w-100 "
    ...
    <script>
        $(function() {
            ...
            let receive_packaging_table = $('#receive_packaging_table').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': '{{ route('api.v1.receive.packaging.list.history.master') }}',
                    'data': {
                ...
                'columns': [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if (row.reject_status == 0) {
                                status =
                                    `<span class='badge badge-pill w-75 text-success' style='font-size:15px;'>นำเข้าสต็อก</span>`

                            } else {
                                status =
                                    `<span class='badge badge-pill w-75 text-danger' style='font-size:15px;'>ตีกลับทั้งหมด</span>`
                            }
                            return status;
                        }
                    },
                    ...
                    },
                    {
                        data: 'id',
                        render: function(data, type, row, meta) {
                            ref = "{{ url('/report/receive/packaging/pdf/') }}";
                ...
                // },
                "dom": '<"top my-1 mr-1"f>rt<"bottom d-flex position-absolute w-100 justify-content-between px-1 mt-3 pb-3"ip><"clear">'
            })
            ...
            function format(receive) {
                ...
                table =
                    '<table cellpadding="5" class="w-100" cellspacing="0" border="0" style="padding-left:50px;"> <caption class="text-center text-dark text-bold pt-0">รายละเอียดบรรจุภัณฑ์นำเข้า</caption>' +
                    inner_table + '</table>';
