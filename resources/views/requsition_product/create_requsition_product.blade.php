    ...
    <div class="row mb-2">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">เพิ่มรายการส่งออกสินค้า</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
        ...
        <form id="form_valid">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2 ">
                        <button type="button" class="btn btn-save ogn-stock-green text-white add-to-table position-absolute" style=" bottom: 0; right: 8px;"><em class="fas fa-plus-circle"></em>  เพิ่มเข้ารายการส่งออก</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="card">
    <div class="card-header ogn-stock-yellow text-left ">
        <em class="fas fa-file-alt text-gray"></em> ใบส่งออกสินค้า
    </div>
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-2">
                ...
                <select name="transport_type" id="transport_type" class="select2 w-100" required>
                    <option value="1">บริษัทเป็นผู้ส่ง</option>
                    <option value="2">ลูกค้ามารับเอง</option>
                    <option value="3">ส่งผ่านบริษัทขนส่ง</option>
                </select>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-2">
                    <label for="" class="form-label">ชื่อ-นามสกุล ผู้รับ</label>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-2">
                    ...
                    <input type="text" id="tumbol" name="tumbol" class="form-control" required>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-2">
                    <label for="" class="form-label">อำเภอ</label>
                    <input type="text" id="aumphur" name="aumphur" class="form-control" required>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-2">
...
<script>
    $(function() {
        ...
        let requsition_product = $('#requsition_product').DataTable({
            "pageLength": 100,
            "responsive": true,
            "paging": false,
            "ordering": false,
            ...
            var    date= $('#date_requsition').val();
                ...
                if (parseFloat(qty) > parseFloat(qty_stock)) {
                    Swal.fire({
                        ...
                        icon: 'warning',
                        title: 'ส่งออกเกินจำนวนที่มีอยู่ในคลัง!',
                ...
                if (rows_product > 0) {
                    Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        type: "post",
                                        url: "{{route('api.v1.requsition.product.create')}}",
                    ...
                    Swal.fire({
                                position: 'center-center',
                                icon: 'warning',
                                title: 'กรุณาเพิ่มรายการส่งออกสินค้า',
                                showConfirmButton: false,
                                timer: 1500
                            })
                }
